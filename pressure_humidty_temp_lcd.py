...
#Create pressure sensor object, comm over boards default I2C bus
i2c = board.I2C()
bmp280 = adafruit_bmp280.Adafruit_BMP280_I2C(i2c)
bmp280.sea_level_pressure = 1013.25

#Create humidity sensor object, with data pin 17:
...
while True:
    ...
    lcd.clear()
    tempC = "Temp: %0.1f C\n" % bmp280.temperature
    tempF = "Temp: %0.1f F" % (bmp280.temperature * (9/5) + 32.0)
    lcd.message = tempC + tempF
    sleep(sleepInt)
    lcd.clear()

    lcd.message = "Pressure:\n %01.2f hPa" % bmp280.pressure
    sleep(sleepInt)
#    lcd.clear()

#    lcd.message = "Altitude:\n %0.2f meters" % bmp280.altitude
#    sleep(sleepInt)
    ...
    #Clear lcd after dht11 gets its reading. It can be slow so leave previous message up.
    lcd.clear()
    lcd.message = "Humidity {}%".format(humidity)
    sleep(sleepInt)
    lcd.clear()